...
participant_decoding_file="/Users/jokedurnez/Box/CAFE Consortium/ParticipantIDs/participant_master/Participants_2019-05-21.csv"

cd $CODEDIR/integration

jwt="*"
# python -i create_org_and_roles.py
# ./integrate.sh 2>&1 | tee full_integration_20190706.txt
...
echo "WIAMP"
python -u integrate_tud.py --cleanfile "$tud_file_cleaned" --study=WIAMP --codedir=$CODEDIR --integrationsdir=$INTEGRATIONSDIR --shuttle=$shuttle --jwt=$jwt 
echo "GU"
...
# 
# echo "GU"
# rawfile="/Users/jokedurnez/Box/CAFE Consortium/Open Lattice Dashboard and Data Integration/GU/GU_MAQs_29April2019_ChoiceText.csv"
...
# cleanfile="/Users/jokedurnez/Box/CAFE Consortium/Open Lattice Dashboard and Data Integration/GU/GU_MAQs_29April2019_ChoiceText_cleanIDs.csv"
# id_column="Q281"
# 
...
# 
# echo "UWCRT"
# rawfile="/Users/jokedurnez/Box/CAFE Consortium/Open Lattice Dashboard and Data Integration/MAQS for WI Studies - as of Feb 6 2019/CAFE+Part+1+-+Survey+-+CREATE_February+6,+2019_08.38 - CHOICE TEXT.csv"
# cleanfile="/Users/jokedurnez/Box/CAFE Consortium/Open Lattice Dashboard and Data Integration/MAQS for WI Studies - as of Feb 6 2019/CAFE+Part+1+-+Survey+-+CREATE_February+6,+2019_08.38 - CHOICE TEXT_cleanIDs.csv"
# id_column='Q262'
# 
# # Rscript preintegration_maq.r "$rawfile" "$cleanfile" "$participant_decoding_file" "$id_column"
# python -u integrate_MAQ.py --cleanfile "$cleanfile" --study=UWCRT --codedir=$CODEDIR --integrationsdir=$INTEGRATIONSDIR --shuttle=$shuttle --jwt=$jwt  
# 
# 
